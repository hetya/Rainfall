We start by opening the file in dogbolt. Here we can see that it use a printf without specifying a format
...
Since with printf we can write on the stack using %n this is a vulnerabilty.
